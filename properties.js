...
var properties = {
    ...
    micSilenceThreshold : 0.02, // minumum mean mic volume (in range of 0.0->1.0) of a frame that contains voice
                                  // used to trigger pause/unpause
                                  // default 0.0175 ok on imacs
    farSilenceThreshold : 0.02, // minimum mean remote volume (in range of 0.0->1.0) of a frame that contains voice
